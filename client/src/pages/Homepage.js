...
const Home = () => {
    ...
    return (
        <main>
            ...
            {Auth.getUser().data.type === "Customer" ? <button className={`button ${theme}-quaternary`} onClick={handleCreateTicketClick} data-target="create-ticket-form">Create New ticket</button> : <label></label>
                    }
            </div>
