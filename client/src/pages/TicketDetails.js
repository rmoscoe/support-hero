        ...
        <div>
            ...
            <div className="block">
                <div className="columns is-multiline is-centered">
                    ...
                    {Auth.getUser().data.type === "Customer" && data.getTicketById.status === "Closed" ? <button className={`${theme}-tertiary button`} onClick={handleSubmitFeedback} data-target="submit-feedback-form">Submit Feedback</button> : <label></label>}
                    </div>
                </div>
