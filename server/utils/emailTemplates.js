...
const commentAddedByAgentHtml = (firstName, ticketId, status, agentFirstName, commentDate, commentText) => {
    ...
    <main style="display: flex; font-family: BlinkMacSystemFont, -apple-system, Segoe UI, 'Roboto', 'Oxygen', 'Ubuntu', 'Cantarell', 'Fira Sans', 'Droid Sans', 'Helvetica Neue', 'Helvetica', 'Arial', sans-serif; justify-content: center; margin-top: 2rem;">
        <p>Hello ${firstName},</p>
        <br/>
        An agent has added a comment to your ticket number <a href="https://dry-fjord-88699.herokuapp.com/tickets/${ticketId}>${ticketId}</a>. The status of your ticket has been updated to <span style="font-weight: 700">${status}</span>.
        <br/>
